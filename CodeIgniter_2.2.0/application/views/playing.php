    ...
    <div class="col-md-9">
        <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">لطفا فیلد های زیر را پر کنید</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form">
                  <div class="box-body">
                    <div class="form-group">
                      <label >فامیل</label>
                      <input type="text" class="form-control" name="family" placeholder="فامیلی را وارد کنید">
                    </div>
                    <div class="form-group">
                      <label>شهر</label>
                    ...
                    <div class="form-group">
                      <label>غذا</label>
                      <input type="text" class="form-control" name="food" placeholder="غذا را وارد کنید">
                    </div>
                    <div class="form-group">
                      <label >حیوان</label>
                      <input type="text" class="form-control" name="animal" placeholder="حیوان را وارد کنید">
                    </div>
                    <div class="form-group">
                      <label>میوه</label>
                      <input type="text" class="form-control" name="fruit" placeholder="میوه را وارد کنید">
                    </div>
                    <div class="form-group">
                      <label>اشیا</label>
                      <input type="text" class="form-control" name="object" placeholder="اشیا را وارد کنید">
                    </div>
                  </div><!-- /.box-body -->
